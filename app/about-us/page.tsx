        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap gap-y-4">
            <div className="w-full lg:w-[50%] flex flex-col justify-center">
              ...
              <p className={`md:text-[19px] text-[18px] ${theme === "light" ? "text-[#000]" : "text-gray-200"} mt-3 md:mt-2 leaing-tight`}>
            ...
            <div className="w-full lg:w-[50%] flex justify-center items-center">
              <Image src="/assets/img/about-us.gif" alt="" width={600} height={440} unoptimized className="mx-auto lg:mx-0 lg:w-[60%]" />
            </div>
          </div>
        </div>
      </section>
