                ...
                <div className="md:p-6 p-2 rounded-lg">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {[
                            ...
                            <div key={field.name}>
                                <input
                                    ...
                                    className={`w-full rounded-[5px] border px-3 py-2 focus:outline-none focus:ring-1 ${theme === "light" ? "bg-white text-black" : "bg-[#1a1a1a] text-white"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`mt-6 w-full font-medium py-2 rounded-[5px] flex justify-center items-center transition ${theme === "light"
